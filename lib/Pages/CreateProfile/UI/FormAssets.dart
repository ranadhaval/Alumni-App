...
standerdTile(
  ...
  return Padding(
    ...
    child: Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(titleFirst, style: TextStyle(fontSize: 15, color: textColor)),
        Row(
          children: [
            Text(titleSecond, style: TextStyle(fontSize: 15, color: textColor)),
...
addCIRSBottomSheet({
  ...
  required String? form2String42,
  required ADDCIRSEducation addcirsEducation,
}) {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: InkWell(
                              onTap: () async {
                                addcirsEducation.addeducation(
                                    context: context,
                                    form2String1: form2String1,
                                    form2String2: form2String2,
                                    form2String3: form2String3,
                                    form2String4: form2String4,
                                    form2String41: form2String41,
                                    form2String42: form2String42);
                              },
                              child: Container(
                                padding: const EdgeInsets.only(
                                    left: 25, right: 25, bottom: 5, top: 5),
...
abstract class ADDCIRSEducation {
  addeducation(
      {required BuildContext context,
      required String? form2String1,
      required String? form2String2,
